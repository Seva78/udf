...
public class Vertebra : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        _mineDictList = GetComponentInParent<Mine>()._mineDictList;
        ...
        if (_mineDictList.Count > 2)
        {
            float CollLengthX = Mathf.Abs(_xSPL - _mineDictList[_mineDictList.Count - 2].GetComponent<Vertebra>().leftPoint.transform.position.x);
            float CollLengthY = Mathf.Abs(_ySPL - _mineDictList[_mineDictList.Count - 2].GetComponent<Vertebra>().leftPoint.transform.position.y);
            ...
            float sin = (_xSPL - _mineDictList[_mineDictList.Count - 2].GetComponent<Vertebra>().leftPoint.transform.position.x) / CollLength;
            ...
            CollLengthX = Mathf.Abs(_xSPR - _mineDictList[_mineDictList.Count - 2].GetComponent<Vertebra>().rightPoint.transform.position.x);
            CollLengthY = Mathf.Abs(_ySPR - _mineDictList[_mineDictList.Count - 2].GetComponent<Vertebra>().rightPoint.transform.position.y);
            CollLength = Mathf.Sqrt(Mathf.Pow(CollLengthX, 2) + Mathf.Pow(CollLengthY, 2));
            ...
            sin = (_xSPR - _mineDictList[_mineDictList.Count - 2].GetComponent<Vertebra>().rightPoint.transform.position.x) / CollLength;
